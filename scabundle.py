...
def connectivity():
    ...
    cmd_to_file(f'{bundledir}/connectivity/sensor_ext', 'curl -so- -D- --conect-timeout=5 https://sensor.ext.obsrvbl.com')
    cmd_to_file(f'{bundledir}/connectivity/sensor_us', 'curl -so- -D- --conect-timeout=5 https://sensor.obsrvbl.obsrvbl.com')
    cmd_to_file(f'{bundledir}/connectivity/sensor_eu', 'curl -so- -D- --conect-timeout=5 https://sensor.eu-prod.obsrvbl.com')
    cmd_to_file(f'{bundledir}/connectivity/sensor_anz', 'curl -so- -D- --conect-timeout=5 https://sensor.anz-prod.obsrvbl.com')
